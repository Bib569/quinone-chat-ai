...
export default async (req: Request) => {
  ...
  try {
    ...
    result.structureImageUrl = `https://pubchem.ncbi.nlm.nih.gov/rest/pug/compound/smiles/${encodeURIComponent(smiles || query)}/PNG?record_type=2d&image_size=300x300`;
